...
from dataset import DrugCellPairDataSet
...
parser.add_argument('--model_name', type=str, default='agw')
...
for var1 in list_var1:
    for var2 in list_var2:
        ...
        attention_net =  ResponseUnit(drug_dim=args.drug_embed_dim, 
                                      ...
                                      dropout=0.2)
        model =          DrugResponseNet(drug_embed_net, attention_net, 
                                         fc_in_dim=args.cell_line_dim+args.drug_embed_dim,
