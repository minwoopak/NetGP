...
from utils import *
from trainer_deers import logging, train, validate, test
...
parser.add_argument('--model_name', type=str, default='deers')
...
for var1 in list_var1:
    for var2 in list_var2:
        ...
        # Forward network
        if args.code_interactions:
            net = ForwardNetworkTwoHiddenLayers(2*args.code_dim + args.code_dim**2, 
            ...
            net = ForwardNetworkTwoHiddenLayers(2*args.code_dim,
                                                  args.forward_net_hidden_dim1,
                                                  args.forward_net_hidden_dim2,
                                                  out_activation=args.forward_net_out_act,
                                                  dropout_rate=args.forward_net_drop_rate)
        ...
        model = DEERS(drug_autoencoder, cell_autoencoder, forward_network=net,
                      code_interactions=args.code_interactions).to(device)
