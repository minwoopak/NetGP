...
```
Outputs gene perturbation profile to `Data/model_input/netGP_profile.out`  
(the extracted gene perturbation profile used in the paper is in the directory `Data/model_input/iterative_enrich_np_consensus.tsv`)
